# web-fetcher-length-limits Specification

## Purpose
TBD - created by openspec-sync-specs from change configurable-webfetcher-length-limits. Update Purpose after archive.
